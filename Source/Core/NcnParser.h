...
struct SongLyrics {
  ...
  std::vector<int> cursors; // MIDI Ticks
};
...
public:
   ...
   * @return A SongLyrics object containing the parsed lyrics and synchronized
   * cursors.
   */
  SongLyrics parse(const juce::File &lyrFile, const juce::File &curFile,
                   int midiResolution);
