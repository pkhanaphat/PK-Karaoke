...
YouTubePlayerComponent::YouTubePlayerComponent() : webBrowser (juce::WebBrowserComponent::Options().withBackend(juce::WebBrowserComponent::Options::Backend::webview2))
{
...
{
    webBrowser.goToURL ("javascript:player.setVolume(" + juce::String(volume0to100) + ");");
}

juce::String YouTubePlayerComponent::getHtmlContent (const juce::String& videoId)
{
